...
<head>
    ...
    <!-- css -->
    <link rel="stylesheet" href="theme_meatking/css/bootstrap.min.css">
    <link rel="stylesheet" href="theme_meatking/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="theme_meatking/css/font-awesome.min.css">
    <link rel="stylesheet" href="theme_meatking/css/main.css">

    <!-- google font -->
    <link rel='stylesheet' href='http://fonts.googleapis.com/css?family=Kreon:300,400,700'>

    <!-- js -->
    <script src="theme_meatking/js/vendor/modernizr-2.6.2-respond-1.1.0.min.js"></script>
</head>
<body data-spy="scroll" data-target="#navbar" data-offset="120" >
    ...
    <div id="menu" class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <div class="hidden-xs" id="logo"><a href="#header">
                <img src="theme_meatking/img/logo.png" alt="">
            </a></div>
        ...
        <div class="container inner">
            ...
            <p class="lead main text-center">There is no sincerer love than the love of food!</p>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/hot-drinks.png" alt="Hot Drinks"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/ice-drinks.png" alt="Ice Drinks"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/smoothies.png" alt="Smoothies"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/deserts.png" alt="Deserts"></div>
            ...
            <div class="row">
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/cocktails.png" alt="Hot Drinks"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/beer.png" alt="Ice Drinks"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/wine.png" alt="Smoothies"></div>
                ...
                <div class="col-sm-3 col-md-3">
                    <div class="menu-images "><img src="theme_meatking/img/menu/sprites.png" alt="Deserts"></div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="theme_meatking/img-responsive img-thumbnail" src="theme_meatking/img/dish/dish3.jpg" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="theme_meatking/img-responsive img-thumbnail" src="theme_meatking/img/dish/dish2.jpg" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="theme_meatking/img-responsive img-thumbnail" src="theme_meatking/img/dish/dish4.jpg" alt=""></a>
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="pricing-item">
                        ...
                        <a href="#"><img class="theme_meatking/img-responsive img-thumbnail" src="theme_meatking/img/dish/dish1.jpg" alt=""></a>
    ...
    <div id="reservation" class="light-wrapper">
        <section class="ss-style-top"></section>
        <div class="container inner">
            <h2 class="section-title text-center">Pesan/Oreder</h2>
            <p class="lead main text-center">Pesan sekarang  &amp; minimal 3 hari sebelum Hari H</p>
            <div class="row">
                <div class="col-md-6">
                    <form class="form form-table" method="post" name="">
                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 form-group">
                            <label class="sr-only" for="first_name1">Nama</label>
                            <input class="form-control hint" type="text" id="name" name="name" placeholder="Nama" required="">
                          </div>
                          <div class="col-lg-6 col-md-6 form-group">
                            <label class="sr-only" for="address">Alamat</label>
                            <input class="form-control hint" type="text" id="address" name="address" placeholder="alamat" required="">
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-lg-6 col-md-6 form-group">
                        ...
                        <div class="row">
                          <div class="col-lg-6 col-md-6 form-group">
                            <label class="sr-only" for="reserv_date">Tanggal pengambilan/pengantaran</label>
                            <input class="form-control datepicker hasDatepicker hint" type="text" id="reserv_date" name="reserv_date" placeholder="Tanggal pengambilan/pengantaran" required="">
                          </div>
                          <div class="col-lg-6 col-md-6 form-group">
                            <label class="sr-only" for="numb_guests1">Porsi/Box</label>
                            <input class="form-control hint" type="text" id="numb_guests1" name="numb_guests" placeholder="Porsi/Box" required="">
                          </div>
                        </div>
                        <div class="row">
        ...
        <div class="container inner">
            ...
            <div class="row text-center chefs">
                <div class="col-sm-4">
                    <div class="col-wrapper">
                        <div class="icon-wrapper">
                            <img src="theme_meatking/img/chefs/1.jpg">
                        </div>
                        <h3>Saransh Goila</h3>
                ...
                <div class="col-sm-4">
                    <div class="col-wrapper">
                        <div class="icon-wrapper">
                            <img src="theme_meatking/img/chefs/3.jpg">
                        </div>
                        <h3>Jane Doe</h3>
                ...
                <div class="col-sm-4">
                    <div class="col-wrapper">
                        <div class="icon-wrapper">
                            <img src="theme_meatking/img/chefs/2.jpg">
                        </div>
    ...
    <script src="theme_meatking/js/jquery-2.1.3.min.js"></script>
    <script src="theme_meatking/js/jquery.actual.min.js"></script>
    <script src="theme_meatking/js/jquery.scrollTo.min.js"></script>
    <script src="theme_meatking/js/bootstrap.min.js"></script>
    <script src="theme_meatking/js/main.js"></script>
</body>
</html>
